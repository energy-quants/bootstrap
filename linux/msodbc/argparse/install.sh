...
# ARG_OPTIONAL_SINGLE([version],[v],[The version of msodbcsql to download and install.],[latest])
# ARG_OPTIONAL_BOOLEAN([list-versions],[l],[Lists the available versions of msodbcsql.],[])
# ARG_DEFAULTS_POS([])
# ARG_HELP([Installs the specified version of msodbc.])
# ARGBASH_GO()
